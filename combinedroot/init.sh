...
# leds configuration
BOOTREC_LED_RED="/sys/class/leds/lv5219lg:rgb1:red/brightness"
BOOTREC_LED_GREEN="/sys/class/leds/lv5219lg:rgb1:green/brightness"
BOOTREC_LED_BLUE="/sys/class/leds/lv5219lg:rgb1:blue/brightness"
...
do
    ...
    case "$type" in
        (*es209ra_keypad*) keypad_input=`busybox echo $input | busybox sed 's/^.*input//'`;;
        (*)               ;;
    esac
done
